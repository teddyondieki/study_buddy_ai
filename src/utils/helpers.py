...
class QuizManager:
    ...
    def generate_questions(self, generator: QuestionGenerator, topic: str, question_type: str,
    ...
    def evaluate_quiz(self):
        ...
        for i, (q, user_ans) in enumerate(zip(self.questions, self.user_answers)):
            ...
            if q['type'] == 'MCQ':
                ...
                result_dict['options'] = []
                result_dict["is_correct"] = user_ans.strip().lower() == q[
